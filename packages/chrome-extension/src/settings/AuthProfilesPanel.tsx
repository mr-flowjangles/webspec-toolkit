/**
 * v1.3 Auth Profiles panel — manage AuthProfiles.
 *
...
export function AuthProfilesPanel(): JSX.Element {
  ...
  return (
    <section className="settings-panel" aria-labelledby="auth-profiles-heading">
      <p id="auth-profiles-heading" className="settings-tagline">
